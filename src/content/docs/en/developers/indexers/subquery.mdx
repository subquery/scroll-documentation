...
lang: "en"
permalink: "developers/indexers/subquery"
excerpt: "Fast, flexible, universal, open source and decentralised APIs for web3 projects"
---

SubQuery is a leading blockchain data indexer that provides developers with fast, flexible, universal, open source and decentralised APIs for web3 projects. SubQuery SDK allows developers to get rich indexed data and build intuitive and immersive decentralised applications in a faster and more efficient way. SubQuery supports 100+ ecosystems including Scroll, Ethereum, Polkadot, Algorand, NEAR, and Avalanche.
...
- [Scroll x SubQuery Indexing Workshop](https://www.youtube.com/watch?v=o0tm7kw5S64)
...
- Mainnet
    - [Mainnet Quick Start Guide](https://academy.subquery.network/quickstart/quickstart_chains/scroll.html)
    - [Mainnet Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Scroll/scroll-starter)
- Sepolia
    - [Sepolia Quick Start Guide](https://academy.subquery.network/quickstart/quickstart_chains/scroll-sepolia.html)
    - [Sepolia Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Scroll/scroll-sepolia-starter)

For technical questions and support reach out to us start@subquery.network

## Running and Hosting your Scroll SubQuery APIs
