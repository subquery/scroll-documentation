...
title: "Indexers"
lang: "en"
permalink: "developers/indexers"
whatsnext: { "SubQuery": "/developers/indexers/subquery/" }
excerpt: "SubQuery Indexer"
---
...
There are several indexer solutions available, each offering different levels of decentralisation, ease of development, and performance for you to consider. These solutions serve as intermediaries to assist in indexing the Scroll network.